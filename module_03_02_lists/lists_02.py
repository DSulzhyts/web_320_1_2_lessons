...
example_list_mix = ["Drama", 2.5, 1, ["Drama", "Comedy", "Fantasy"]]

example_list_str_1 = ["Drama", "Comedy", "Fantasy", "Drama", "Comedy", "Fantasy"]
print(example_list_str_1)
example_list_set = list(set(example_list_str_1))
